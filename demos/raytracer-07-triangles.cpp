...
struct Scene {
    ...
    Scene(std::vector<Sphere> v_spheres, std::vector<Triangle> v_triangles, std::vector<Light> v_lights, float3 v_background_color) {
        spheres = v_spheres;
...
int32_t main() {
    ...
    Scene scene = Scene(spheres, triangles, lights, {0, 0, 0});
